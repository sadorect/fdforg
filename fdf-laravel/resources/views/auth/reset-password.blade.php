        ...
        <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
            <form method="POST" action="{{ route('password.update') }}" class="space-y-4">
                ...
                <div class="rounded-lg border border-gray-200 bg-slate-50 p-4">
                    ...
                    <input type="email" name="email" value="{{ old('email', $email) }}" required class="mt-2 w-full rounded-md border-2 border-slate-300 bg-white px-3 py-2 text-gray-900 focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="rounded-lg border border-gray-200 bg-slate-50 p-4">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            <label class="text-xs font-medium text-gray-700">New Password</label>
                ...
                <div class="rounded-md border border-gray-200 bg-gray-50 p-4">
                    ...
                    <div class="mt-2 flex items-center gap-3">
                        ...
                        <a href="{{ route('password.reset', ['token' => $token, 'email' => old('email', $email), 'refresh_captcha' => 1]) }}" class="text-sm font-semibold text-blue-600 hover:text-blue-800">New CAPTCHA</a>
                    </div>
